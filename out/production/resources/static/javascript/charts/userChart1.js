...
async function demo() {
    ...
    while (true) {
        $cantidadMes1.text(11);
        $cantidadMes2.text(12);
        $cantidadMes3.text(13);
        $cantidadMes4.text(14);
        $cantidadMes5.text(10);
        $cantidadMes6.text(10);
        console.log("Esta mierda sí está entrando acá");
        await sleep(8000);
        let myChart = new Chart(ctx, {
            type: 'bar',
            data: dataForTheChart,
        ...
        console.log("Y esta mierda sí está esperando 4 segundos");
    }
}
